  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="mb-4 flex items-center gap-4">
        ...
        >
          <ChevronLeft className="h-3.5 w-3.5" /> Voltar para o início
        </Link>
      ...
      {/* 3-column layout */}
      <div className="grid min-h-0 flex-1 grid-cols-[1fr_auto_1fr] gap-4 overflow-hidden">

        {/* ── Esquerda: Briefing + tabs ── */}
        ...
        <div className="flex min-h-0 w-[280px] flex-col overflow-hidden">
        ...
        <div className="flex min-h-0 flex-col gap-3 overflow-hidden">
          ...
          <div className="min-h-0 flex-1 overflow-auto">
            {rightTab === "camadas" ? (
              /* Camadas estilo do print — lista vertical com nome, desc e v1 */
              <div className="flex flex-col gap-1.5 rounded-xl border border-border bg-card p-3">
                {LAYERS.map((layer) => {
                  ...
                  const done = state.doneLayers.includes(layer.key)
                  return (
                    <div
                      key={layer.key}
                      className={cn(
